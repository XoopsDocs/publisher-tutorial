...
| --- | --- | --- |
| URL rewrite method | If you choose htaccess, then don't forget to put “.htaccess” file under your root folder | None,  Path-Info,  htaccess |
| URL Rewriting module name | If URL Rewriting is enabled for the module, this is the name of the module that will be used. For example: [http://yoursite.com/publisher/](http://yoursite.com/publisher/)... | publisher |
...
| Other articles display type | Select how you would like to display the other articles of the category in the article page. | None  Previous & Next Article  All Articles |
|  | **Index and category pages** |  |
| Display sub categories | Select if you want to display the subcategories in the categories list of the index and category page of the module. | Do not display subcategorios   Display non-empty subcategorios   Display all subcategories   Do not display subcategories in index page, just in category page   |
...
| Articles display type: | if “Summary View” is selected, only the Title, Date and Hits of each item will be displayed in a selected category. If “Full View” is selected, each article will be fully displayed in a selected category. | Summary View   Full View   Bullet View   WF-Section Style |
